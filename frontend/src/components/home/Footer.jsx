...
const Footer = () => {
  return (
    ...
    bg-gradient-to-b from-emerald-900/30 via-zinc-950 to-black 
    border-t border-emerald-700/20"
      >
        {/* LOGO */}
        ...
        <p className="mt-4 text-center text-zinc-400">
          © 2025 <span className="text-emerald-400">Sustainify</span>. All
          rights reserved.
        </p>
        ...
        <div className="flex items-center gap-4 mt-5">
          <a
            href="https://www.facebook.com/SuRaJThKr7/"
          ...
          <a
            href="https://www.instagram.com/_surraaaj/"
            className="hover:-translate-y-0.5 transition-all duration-300"
          >
            <svg
              width="24"
